...
if __name__ == '__main__':
    ...
    try:
        ...
        elif requestCode == "A1T1": print(alg1_1GraphTraversal_AnyNodeToAnyNode(sys.argv[1], sys.argv[2]))
        elif requestCode == "A1T2": print(alg1_2GraphTraversal_GivenNodeToAnyNode(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]))
        elif requestCode == "A1T3": print(alg1_3GraphTraversal_GivenNodeToGivenNode(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6]))
        elif requestCode == "A1T4": print(alg1_4EvalPossiblePaths_GivenNodeToGivenNode(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]))
        elif requestCode == "A1T5": print(alg1_5GraphTraversal_AnyNodeToGivenNode(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]))

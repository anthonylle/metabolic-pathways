...
router.post('/python', (req, res) => {
  callPython(['./python/Main.py', 'cit00710.xml', 'S1']).then(fromCallBack => {
    console.log(fromCallBack.toString());
    res.end(fromCallBack);
  }).catch(err => {
    res.end(err);
